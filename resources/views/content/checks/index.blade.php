            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h6 class="card-title mb-0">Data Check</h6>
                                ...
                                @foreach ($checks as $item)
                                    <tr data-item="{{ json_encode($item) }}">
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('checks.destroy', $item->check_id) }}" style="display:none;" class="delete-form">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addEditModalLabel">Tambah/Edit Data Check</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="{{ route('checks.save') }}" id="dataForm">
                    @csrf
